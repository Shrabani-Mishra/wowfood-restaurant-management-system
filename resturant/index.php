...
if (isset($_SESSION['order'])) {
    echo $_SESSION['order'];   // Show message
    unset($_SESSION['order']); // Remove message after displaying
}
?>
...
<section class="food-menu">
    <div class="container">
        ...
        <?php 
        // Query to get active & featured foods
        $sql = "SELECT * FROM `tbl-food` WHERE active='Yes' AND featured='Yes' LIMIT 6";
        $res = mysqli_query($conn, $sql);
        ...
        <div class="food-menu-box">
            ...
            <div class="food-menu-desc">
                ...
                <br>
                <!-- this is the get method for food id which food is ordered-->
        ...
        <?php
                ...
                echo "<div class='error text-center'>No foods found.</div>";
            }
        }
        ?>
